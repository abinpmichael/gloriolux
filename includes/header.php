...
<head>
    ...
    if (!isset($page_meta_title)) {
        ...
        $page_schema = $seo_data ? $seo_data['schema_code'] : '';
    }
    ?>
    <title><?php echo htmlspecialchars($page_meta_title ?? 'Gloriolux'); ?></title>
    <meta name="description" content="<?php echo htmlspecialchars($page_meta_desc ?? 'Premium hand-poured luxury soy candles.'); ?>">
