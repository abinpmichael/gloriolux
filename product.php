            ...
            <div style="flex: 1; min-width: 300px;">
                ...
                <div style="margin-top: 2rem; padding-top: 2rem; border-top: 1px solid #eee;">
                    ...
                    <div style="display: flex; gap: 1rem;">
                        ...
                        <a href="#" onclick="shareToInstagram(event, '<?= htmlspecialchars($product['name'], ENT_QUOTES, 'UTF-8') ?>')" style="display: inline-flex; align-items: center; justify-content: center; width: 35px; height: 35px; border-radius: 50%; background: #f8f9fa; color: #c13584; text-decoration: none; transition: all 0.3s; border: 1px solid #ddd;" title="Share on Instagram"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </div>
