        ...
        <div style="margin-top: 4rem; padding-top: 2rem; border-top: 1px solid #eee; text-align: center;">
            <div style="margin-bottom: 2rem;">
                ...
                <div style="display: flex; justify-content: center; gap: 1rem;">
                    ...
                    <a href="#" onclick="shareToInstagram(event, '<?= htmlspecialchars($post['title'], ENT_QUOTES, 'UTF-8') ?>')" style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; border-radius: 50%; background: #c13584; color: #fff; text-decoration: none; transition: transform 0.3s;" title="Share on Instagram"><i class="fab fa-instagram"></i></a>
