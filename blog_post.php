...
if (!$post) {
    header("Location: /Gloriolux/blog.php");
    exit;
}
...
<main class="main-content">
    <div style="width: 100%; height: 400px; position: relative; background: #000;">
        <?php if($post['image_url']): ?>
            <img src="/Gloriolux/<?= htmlspecialchars($post['image_url']) ?>" alt="<?= htmlspecialchars($post['title']) ?>" style="width: 100%; height: 100%; object-fit: cover; opacity: 0.7;">
        <?php endif; ?>
    ...
    <div class="container" style="padding-top: 50px; padding-bottom: 80px; max-width: 800px;">
        ...
        <div style="margin-top: 4rem; padding-top: 2rem; border-top: 1px solid #eee; text-align: center;">
            ...
            <a href="/Gloriolux/blog.php" class="btn btn-outline" style="color: var(--primary-color); border-color: var(--primary-color);">Back to Blog</a>
        </div>
    </div>
</main>
